...
import com.safeNest.features.call.callDetection.impl.presentation.service.handler.CallResult
            ...
            withContext(Dispatchers.Main) {
                ...
                if (result is CallResult.Reject) {
                    ...
                    Handler(Looper.getMainLooper()).post {
                        Toast.makeText(applicationContext,"Cannot perform this call",Toast.LENGTH_LONG).show()
                    }
                    cancelCall()
                } else {
                    placeCallUnmodified()
