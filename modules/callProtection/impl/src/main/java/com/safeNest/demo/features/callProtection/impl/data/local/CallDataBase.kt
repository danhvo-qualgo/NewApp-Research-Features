...
@Database(entities = [WhitelistEntity::class,
    BlacklistPatternEntity::class,
    MasterWhitelistEntity::class,
    MasterBlocklistEntity::class,
    CallTrackingEntity::class], version = 2
)
abstract class CallDataBase : RoomDatabase() {
    ...
    abstract fun callTrackingDao(): CallTrackingDao
}