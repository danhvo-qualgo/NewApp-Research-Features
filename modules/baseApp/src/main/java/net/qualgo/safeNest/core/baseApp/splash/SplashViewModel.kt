package net.qualgo.safeNest.core.baseApp.splash

import androidx.lifecycle.viewModelScope
import net.qualgo.safeNest.core.baseApp.base.viewModel.BaseViewModel
import net.qualgo.safeNest.core.baseApp.base.viewModel.DefaultBaseUiHost
