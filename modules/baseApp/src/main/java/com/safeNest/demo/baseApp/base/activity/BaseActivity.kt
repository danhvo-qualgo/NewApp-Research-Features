...
open class BaseActivity : ComponentActivity() {
    ...
    @Inject
    internal lateinit var activityDelegate: com.safeNest.demo.baseApp.base.activity.DefaultActivityDelegate
    ...
    open fun createActivityDelegate(): com.safeNest.demo.baseApp.base.activity.ActivityDelegate {
