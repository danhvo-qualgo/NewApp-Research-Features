...
//        "https://huggingface.co/cik009/whisper/resolve/main/whisper-tiny.tflite"
    private const val MODEL_URL =
        "https://drive.usercontent.google.com/download?id=1ZcQ11AdYcp1kUGbuOY63169kpryThUR9&export=download&authuser=0"
    //tiny:  https://drive.usercontent.google.com/download?id=1tRPTdvajXVXVlb9snwwdzGyCPVcldozj&export=download&authuser=0
    //base:  https://drive.usercontent.google.com/download?id=1ZcQ11AdYcp1kUGbuOY63169kpryThUR9&export=download&authuser=0
    //small: https://drive.usercontent.google.com/download?id=101KmBZCVTUZre2HiY0OOWYm9u_GJ0R-x&export=download&authuser=0
...
//        "https://huggingface.co/openai/whisper-tiny/resolve/main/vocab.json"
    private const val VOCAB_URL =
        "https://huggingface.co/vinai/PhoWhisper-base/resolve/main/vocab.json"
    //tiny:  https://huggingface.co/vinai/PhoWhisper-tiny/resolve/main/vocab.json
    //base:  https://huggingface.co/vinai/PhoWhisper-base/resolve/main/vocab.json
    //small: https://huggingface.co/vinai/PhoWhisper-small/resolve/main/vocab.json
